        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hero = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(19,10)", nullable: false),
                    Order = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Published = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeatureAttributes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FeatureAttributes_Features_FeatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogPostsMedia", x => new { x.MediaId, x.BlogPostId });
                    table.ForeignKey(
                        name: "FK_BlogPostsMedia_BlogPosts_BlogPostId",
                        column: x => x.BlogPostId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogPostsMedia_Media_MediaId",
                        column: x => x.MediaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopCategoryFeatures", x => new { x.ShopCategoryId, x.ProductFeatureId });
                    table.ForeignKey(
                        name: "FK_ShopCategoryFeatures_Features_ProductFeatureId",
                        column: x => x.ProductFeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopCategoryFeatures_ShopCategories_ShopCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductMedia", x => new { x.MediaId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductShopCategories", x => new { x.ShopCategoryId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductShopCategories_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductShopCategories_ShopCategories_ShopCategoryId",
                        column: x => x.ShopCategoryId,
                        principalTable: "ShopCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventMedia", x => new { x.EventId, x.MediaId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventMedia_Media_MediaId",
                        column: x => x.MediaId,
                        principalTable: "Media",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeatureAttributesId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAttributes", x => new { x.FeatureAttributesId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ProductAttributes_FeatureAttributes_FeatureAttributesId",
                        column: x => x.FeatureAttributesId,
                        principalTable: "FeatureAttributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPostsMedia_BlogPostId",
                table: "BlogPostsMedia",
                column: "BlogPostId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeatureAttributes_FeatureId",
                table: "FeatureAttributes",
                column: "FeatureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductShopCategories_ProductId",
                table: "ProductShopCategories",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopCategoryFeatures_ProductFeatureId",
                table: "ShopCategoryFeatures",
