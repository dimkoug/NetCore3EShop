...
namespace ShopProject3.Profiles
{
    public class AutoMapperProfile :Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Banners, BannersEntity>().ReverseMap();
            CreateMap<PressReleases, PressReleasesEntity>().ReverseMap();
            CreateMap<Events, EventsEntity>().ReverseMap();
            CreateMap<EventsMedia, EventsMediaEntity>().ReverseMap();
            CreateMap<Offers, OffersEntity>().ReverseMap();
            CreateMap<OffersDetail, OffersDetailEntity>().ReverseMap();
        }
    }
}
