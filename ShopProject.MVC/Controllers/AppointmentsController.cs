...
namespace ShopProject.MVC.Controllers
{
    ...
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var controller = nameof(AppointmentsController).Split("Controller")[0];
            var data = await _appointmentService.GetAll();
            var html = "index";
        ...
        public async Task<IActionResult> Details(int? Id)
        {
            ...
            var model = await _appointmentService.Get(Id);
            if (User.IsInRole(Roles.Owner) || User.Identity.IsAuthenticated)
            {
                html = "managedetail";
            }
        ...
        public async Task<IActionResult> Edit(int Id)
        {
            ...
            var viewModel = await _appointmentService.Get(Id);
            return View(viewModel);
        }
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> DeleteConfirmed(int? Id, Appointment viewModel)
        {
        ...
        {
            return await _appointmentService.Exists(id);
        }
    }
}
