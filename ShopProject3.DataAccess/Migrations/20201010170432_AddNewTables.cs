    ...
    public partial class AddNewTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductMedia", x => new { x.DocumentId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductId = table.Column<int>(nullable: false),
                    FeatureAttributeId = table.Column<int>(nullable: false),
                    Order = table.Column<int>(nullable: false),
                    Published = table.Column<bool>(nullable: false),
                    Deleted = table.Column<bool>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductFeatureAttributes", x => new { x.FeatureAttributeId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductFeatureAttributes_FeatureAttributes_FeatureAttributeId",
                        column: x => x.FeatureAttributeId,
                        principalTable: "FeatureAttributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductFeatureAttributes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFeatureAttributes_ProductId",
